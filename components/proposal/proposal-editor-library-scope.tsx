...
/** Library / Explore media sidebar and contract-template sidebar shell. */
export const PROPOSAL_EDITOR_LIBRARY_ASIDE_CLASS =
  "absolute left-0 top-0 z-[90] flex h-full w-[min(100%,380px)] flex-col border-r border-border/80 bg-background/85 shadow-2xl backdrop-blur-md supports-[backdrop-filter]:bg-background/70";
